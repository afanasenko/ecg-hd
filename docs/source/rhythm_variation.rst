...
- "ULF" [мс2] мощность в диапазоне < 0,003 Гц (не имеет смысла для
записей короче 10 минут)
...
Переменные fp и sp содержат спектр мощности и предназначены для отладки.
fp - значения частоты (Гц), sp - значения спектральной мощности (мс2).
